...
public interface ICustomerForLitedbService
{
...
public class CustomerForLitedbService : ICustomerForLitedbService
{
    readonly ILiteCollection<vCard> collection;

    public CustomerForLitedbService()
    {
        var cnx = new ConnectionString()
        {
            Filename = FileHelper.GetFileDbPath("Custome")
        };
