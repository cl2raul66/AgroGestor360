...
public interface ISupplierForLitedbService
{
...
public class SupplierForLitedbService : ISupplierForLitedbService
{
    readonly ILiteCollection<vCard> collection;

    public SupplierForLitedbService()
    {
        var cnx = new ConnectionString()
        {
            Filename = FileHelper.GetFileDbPath("Supplier")
        };
